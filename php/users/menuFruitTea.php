    ...
    <section class="sec2">
        <div class="grid-container">
            ...
            <div class="labelbar">
                ...
                <h4>|</h4>
                <h4 style="color: #E27396"><a href="menuFruitTea.php">Fruit Tea</a></h4>
                <h4>|</h4>
            ...
            <div class="navbar">
                ...
                <a id="navtitle" href="#">Fruit Tea</a>
                <a href="menuLemonade.php">></a>
            </div>

            <?php
                    $select = mysqli_query($conn, "SELECT * FROM items WHERE pr_category ='FruitTea'") or die("Query Failed");
