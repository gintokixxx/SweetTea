...
<body>
    ...
    <section class="sec2">
        <div class="grid-container">
            ...
            <div class="labelbar">
                <h4 style="color: #E27396"><a href="menuMilktea.php">Milktea</a></h4>
                <h4>|</h4>
            ...
            <div class="navbar">
                <a href="menuSnacks.php"><</a>
                <a id="navtitle" href="#">Milktea</a>
                <a href="menuCoffee.php">></a>
            </div>

            <?php
                    $select = mysqli_query($conn, "SELECT * FROM items WHERE pr_category ='Milktea'") or die("Query Failed");
