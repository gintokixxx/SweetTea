    ...
    <section class="sec2">
        <div class="grid-container">
            ...
            <div class="labelbar">
                ...
                <h4>|</h4>
                <h4 style="color: #E27396"><a href="menuCoffee.php">Coffee</a></h4>
                <h4>|</h4>
                <h4><a href="menuFruitTea.php">Fruit Tea</a></h4>
                <h4>|</h4>
                <h4><a href="menuLemonade.php">Lemonade</a></h4>
                <h4>|</h4>
                <h4><a href="menuSnacks.php">Snacks</a></h4>
            </div>

            <div class="navbar">
                <a href="menuMilktea.php"><</a>
                <a id="navtitle" href="#">Coffee</a>
                <a href="menuFruitTea.php">></a>
            </div>

            <?php
                    $select = mysqli_query($conn, "SELECT * FROM items WHERE pr_category ='Coffee'") or die("Query Failed");
